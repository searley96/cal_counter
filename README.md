...
I wanted to create a project that would allow me to practice form validation. This project was built with HTML, CSS, and JavaScript. This app allows the user to easily calculate whether they have had a calorie surplus or deficit for the day. The user can enter in their daily calorie intake goal, the calories they consumed that day, as well as any exercise they've done that day, and click the 'Calculate Remaining Calories' button to see how many calories they have consumed/burned off that day. Their total calories count will highlight green if they have a surplus of calories for the day, and will highlight red if they have a deficit of calories. 
